    ...
    <div className="min-h-screen bg-surface flex items-center justify-center px-6 pt-20 pb-32">
      ...
      >
        <div className="text-center space-y-4 mb-10">
          <div className="w-16 h-16 bg-accent-peach rounded-2xl flex items-center justify-center mx-auto text-primary">
            <Heart size={32} fill="currentColor" />
          </div>
          <h1 className="text-4xl font-headline font-bold text-on-surface">Join Us</h1>
          <p className="text-on-surface-variant font-serif italic">Create an account to save your wishlist.</p>
        </div>

        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-4">
            <div className="space-y-2">
              <label className="font-label text-[10px] uppercase tracking-widest font-bold text-outline ml-1">Full Name</label>
          ...
          <div className="relative py-4">
            ...
            <div className="relative flex justify-center text-[10px] uppercase tracking-widest font-bold">
              <span className="px-4 bg-white text-outline">Or continue with</span>
            </div>
          </div>
          ...
          <button 
            ...
            disabled={isLoading}
            className="w-full bg-white text-on-surface py-4 rounded-2xl font-label text-sm font-bold border border-outline-variant/30 hover:bg-surface transition-all flex items-center justify-center gap-3 disabled:opacity-50"
          >
        ...
        <div className="mt-10 text-center space-y-4">
          <p className="text-sm text-on-surface-variant font-body">
            ...
            <Link to="/login" state={{ from: location.state?.from }} className="text-primary font-bold hover:underline">Login</Link>
          </p>
